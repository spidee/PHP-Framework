...
$language_data = array (
    ...
    'STYLES' => array(
        'KEYWORDS' => array(
            1 => 'color: #0000ff; font-weight: bold;',      // mix
            2 => 'color: #0000ff; font-weight: bold;',      // mix
            ...
            10 => 'color: #0000ff; font-weight: bold;',      // operators
            11 => 'color: #0000ff; font-weight: bold;',      // operators
    ...
    'URLS' => array(
        1 => 'http://search.mysql.com/search/query/search?q={FNAME}&group=DevZone&x=0&y=0',
        2 => 'http://search.mysql.com/search/query/search?q={FNAME}&group=DevZone&x=0&y=0',
        3 => 'http://search.mysql.com/search/query/search?q={FNAME}&group=DevZone&x=0&y=0',
        4 => 'http://search.mysql.com/search/query/search?q={FNAME}&group=DevZone&x=0&y=0',
        5 => 'http://search.mysql.com/search/query/search?q={FNAME}&group=DevZone&x=0&y=0',
        6 => 'http://search.mysql.com/search/query/search?q={FNAME}&group=DevZone&x=0&y=0',
        7 => 'http://search.mysql.com/search/query/search?q={FNAME}&group=DevZone&x=0&y=0',
        8 => 'http://search.mysql.com/search/query/search?q={FNAME}&group=DevZone&x=0&y=0',
        9 => 'http://search.mysql.com/search/query/search?q={FNAME}&group=DevZone&x=0&y=0',
